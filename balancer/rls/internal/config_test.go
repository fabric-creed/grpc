...
import (
	...
	_ "github.com/fabric-creed/grpc/balancer/grpclb" // grpclb for config parsing.
	rlspb "github.com/fabric-creed/grpc/balancer/rls/internal/proto/grpc_lookup_v1"
	_ "github.com/fabric-creed/grpc/internal/resolver/passthrough" // passthrough resolver.
)
