...
import (
	_ "github.com/fabric-creed/grpc/xds/internal/balancer" // Register the balancers.
	_ "github.com/fabric-creed/grpc/xds/internal/resolver" // Register the xds_resolver
)
