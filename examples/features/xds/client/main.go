...
import (
	...
	pb "github.com/fabric-creed/grpc/examples/helloworld/helloworld"

	_ "github.com/fabric-creed/grpc/xds/experimental" // To install the xds resolvers and balancers.
)
